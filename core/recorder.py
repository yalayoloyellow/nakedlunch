...
# (решение владельца 2026-08-01: захват окна + режим записи, композитный канвас
...
# владельца: сводить будем потом, исходники не трогаем никогда.
#
...
#    о нём нельзя (владелец: испорченную запись лучше увидеть сразу).
#
