...
#
# Пользователь: «пайплайн в серии выбирается же из профилей пайплайна — там же уже
...
# ищет цепочку по имени через `by_name`, там их не было, и пользователь упирался в
