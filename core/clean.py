...
def knobs(raw: dict | None) -> dict:
    ...
    banality = num("banality", 0.0, 1.0, 0.83, "banal")  # 0 банально ↔ 1 свежо
...
KNOB_OPINIONS = {
    ...
    # ДВУСТОРОННЯЯ (Раунд 58, владелец): 0 — максимально банально и затаскано,
    # 0.5 — ручка не работает, 1 — максимально свежо и несцеплено. Шкала
