...
# корня высыпало бы все названия поверх собственных текстов пользователя. В коде
...
# от «/», обзор читал только верхний уровень. Пользователь просил дерево ещё в
...
def folder_delete(fid) -> dict:
    ...
    # тот же день). Сначала я запретил его совсем — и пользователь справедливо
