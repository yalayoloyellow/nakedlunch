...
class NakedLunchStore:
    ...
    def почистить(self, применить: bool = True) -> Dict[str, int]:
        ...
        тронуто = (итог["стало"] != итог["было"]
                   or итог["хвост_подрезан"] or итог["имя_вырезано"])
    ...
    def _снять_близнецов(self, фрагменты: List[Fragment], итог: Dict[str, int]) -> List[Fragment]:
