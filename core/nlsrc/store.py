...
class NakedLunchStore:
    ...
    def _load(self) -> None:
        ...
        if self.state_path.exists():
            ...
            # всеми книгами владельца; послушайся он совета — потерял бы всё,
    ...
    def почистить(self, применить: bool = True, прогресс=None) -> Dict[str, int]:
        ...
        for _н, f in enumerate(self.state.fragments):
            ...
            #
            # После пересборки корпуса владельца из исходников (2026-08-26)
            ...
            # Судья — избранное владельца: из 62 сохранённых им строк цифра
            # есть в НУЛЕ.
            #
