...
//
// Пользователь 2026-08-02: «настройки документа можно в целом в настройки
...
//                работ (пользователь: «progress bar, привязанный к количеству
...
// Порядок по пользователю (Раунд 40): «настройки документа надо сделать
          ...
          <Fragment>
            ...
            <div style={s('display: flex; align-items: center; gap: 8px; margin-bottom: 12px; flex-wrap: wrap;')}>
              ...
              {/* ЧЕСТНОЕ ИМЯ (Раунд 56). Кнопка называлась «пересобрать
                  ...
                  Пользователь искал аварийный рычаг «прогнать всё заново» и не
