...
//     клик → recToggle (methods.fsrec.js), захват окна и MediaRecorder →
//     freestyle/rec-video.js, куски уходят мостом в питон (launch.py, rec_start/
//     rec_chunk) и ложатся файлами в ~/Documents/nakedlunch/записи. Заперта
