...
export function createAudio(opts) {
  ...
  return {
    ...
    /**
     * Синтетика вручную (Раунд 56). Отчёт: микрофон включён и не работает — возможно, из-за синтетического шума; нужна
     отдельная кнопка ручного управления..
     * @param {boolean} on
     */
    setSynth(on) {
      synthWanted = !!on;
