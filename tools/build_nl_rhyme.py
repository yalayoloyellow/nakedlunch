...
def _внутренняя_рифма(morph, acc, text: str) -> bool:
    ...
    правило возвращало позиции рифмующихся слов, кэш нёс «inner_sp»,
    индекс — inner_off/inner_pos, лента подчёркивала. Проверено глазами
...
# ВСЕ СЛОВА, А НЕ ТОЛЬКО ПОСЛЕДНЕЕ (2026-08-30). требование: «рифма
