...
# (2026-08-02, владелец: «строфа должна как профиль работать — это настройки
# крутилок плюс сама рифмовка»). Тесты на реальных файлах во временном
...
def свой_каталог(tmp_path, monkeypatch):
    """Профили и настройки — в tmp, чтобы тест не трогал данные владельца."""
...
def test_forma_hranit_tolko_karkas(свой_каталог):
    ...
    Владелец 2026-08-03: «можно делать строфы, и можно сделать профиль
    настроек, то есть как расположены крутилки; и то, и то можно ставить
    отдельно». Раньше save() принимал третьим аргументом params, и выбор формы
