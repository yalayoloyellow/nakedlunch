...
КРУТИЛКИ = {"Источники": 0.9, "Мелодичность": 0.15, "Диссонанс": 0.25}
...
def test_настройки_сливают_а_не_затирают(свой_каталог):
    ...
    settings_mod.write({"nl_params": {"params": {"Мелодичность": 0.5}}})
    ...
    assert итог["nl_params"]["params"]["Мелодичность"] == 0.5
