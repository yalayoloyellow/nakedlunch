# nakedlunch — вторая полка: ПРОФИЛИ НАСТРОЕК (Раунд 50, пользователь: «можно
...
#
# Проверяется РЕЗУЛЬТАТ, а не наличие ключа: пользователь на этом уже обжигался
...
def test_классика_не_хранит_мнений():
    """Пользователь: «всё, что не работает, лучше убрать вовсе». Профиль в режиме
