...
# верхний уровень. Владелец просил дерево ещё в брифе редактора, а раскладка
...
def test_vosstanovlenie_vossozdayot_udalyonnoe_derevo(vault):
    ...
    # Корень серий приложением не удаляется (Раунд 55) — но в Finder владелец
...
def test_udalenie_papki_podnimaet_soderzhimoe_naverh(vault):
    ...
    одно и то же; с деревом — удалив «Серии/Пепел», владелец высыпал бы весь
