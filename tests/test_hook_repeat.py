...
#
# Пользователь 2026-08-04, дословно: «хук — это такой тип строфы, он подразумевает
...
# что пользователь и указал: «странно, что он борется с повторяющимся».
#
...
# формы строф: пользователь справедливо спросил, почему серия не видит «три
...
def test_seriya_nahodit_vstroennuyu_po_imeni():
    ...
    фронте. Пользователь: «там же уже три сохранённых пресета пайплайна есть,
