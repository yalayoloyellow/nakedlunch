...
#
# Владелец разобрал раскладку и сформулировал её так:
#
...
def test_кривая_не_живёт_в_пайплайне():
    """Владелец: «искажение же должно быть в серии, а не в пайплайне —
    искажение в серии влияет на пайплайны из этой серии». Плюс форму ОДНОГО
...
def test_stroka_serii_vezde_trek():
    ...
    быть одно — иначе владелец ищет в интерфейсе три разные сущности."""
    текст = МЕНЮ.read_text("utf-8")
