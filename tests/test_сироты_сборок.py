...
# обоих через subprocess.Popen. Закрыл окно — программы для владельца нет, а
...
def дети():
    ...
    в живых, отравил бы машину владельца на две минуты."""
    заведённые = []
...
def test_nashe_gashenie_ne_pishetsya_kak_avariya(сервер, дети, monkeypatch, tmp_path):
    ...
    окна врало бы владельцу в шапке следующего запуска."""
