...
#
# ЧТО НАШЛОСЬ. В data/settings.json владельца, в `nl_params.params`, лежал
...
# Но файл — то, что владелец открывает руками, и он показывал набор ручек,
...
# ---------------------------------------------------------------------------
# ПОТЕРЯ ПРОФИЛЕЙ (Раунд 57). 2026-08-05 у владельца из data/settings.json
