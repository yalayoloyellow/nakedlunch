...
# цепочки; решение остаётся таким, каким его сохранили.. И отдельно: «почему она не хранит референс? Либо, если пустой
...
def test_pustoy_referens_eto_znachenie_a_ne_otsutstvie(свой_каталог):
    """Отчёт: пустой референс не сохранялся как пустой.. Пустой текст значит «собрано руками» — и восстановление обязано
